...
readcolumn
    ...
    dec numbertilesy	; all tiles done?
    beq rc3
...
extractrow
    ...
    lda tilex
    sta tiletmp ; first tile offset starts from tilex
...
extract
    ...
    ldy tilex
    dey
ext1    ; write color for last tile if tilex>0
    sta (colourmem),y
    dey
    bpl ext1
    bmi ext3 ; branch always
ext2    ; write color for all tiles except the above case
    ldy #$00
    sta (colourmem),y
    iny
    sta (colourmem),y
...
;---------------------------------------
	...
	*=charaddr
	.binary "../resources/MetalWarrior-L6/char.bin"
	
	*=tilesaddr
	.binary "../resources/MetalWarrior-L6/tile.bin"
	
	*=mapaddr
	.binary "../resources/MetalWarrior-L6/map.bin"
	
	*=attribsaddr
	.binary "../resources/MetalWarrior-L6/attribs.bin"